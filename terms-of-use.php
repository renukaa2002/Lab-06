	...
	<body id="section6">
		...
		<header>
			...
			<nav>
				<ul>
				    ...
				    <li><a href="../green.php" title="Learn about blue blocks">Green Blocks</a></li>
				</ul>
			</nav>
		</header>
		...
		<footer>
			<nav>
				...
				<li><a href="terms-of-use.php" title="Information related to term-of-use">Terms of use</a> | <a href="about/terms-of-use.php#limitation-liability" title="Learn about how limitation liability works">Using information</a></li>
			</nav>
